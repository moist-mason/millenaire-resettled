...
public class MillenaireRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildBlockCraftingRecipes(RecipeOutput output) {
        ...
        twoSquaredRecipe(output, WHEAT, THATCH);
        ...
        twoSquaredRecipe(output, PLASTERED_MUD, PLASTERED_MUD_BRICKS, 4);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, PLASTERED_MUD_BRICKS)
                .requires(LIME_PLASTER_BUCKET)
                .requires(Blocks.MUD_BRICKS)
                .unlockedBy("has_lime_plaster_bucket", has(LIME_PLASTER_BUCKET))
                .unlockedBy("has_mud_brick", has(MUD_BRICKS)).save(output, modResource("plastered_mud_brick_from_mud_brick"));
        ...
        twoSquaredRecipe(output, LIGHT_BLUE_CONCRETE, LIGHT_BLUE_CONCRETE_BRICKS);
        ...
        twoSquaredRecipe(output, DIRT, DIRT_WALL);
